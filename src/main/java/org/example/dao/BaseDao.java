...
public abstract class BaseDao<T> {
    ...
    public abstract boolean addBankAccount(T element) throws SQLException;
    public abstract boolean updateBalance(T element) throws SQLException;

    public abstract boolean addOperation(T element) throws SQLException;
}
